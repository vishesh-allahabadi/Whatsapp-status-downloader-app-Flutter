...
import 'package:whatsapp_status_downloader/ui/dashboard.dart';
import 'package:whatsapp_status_downloader/ui/mydrawer.dart';
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
              ...
              onPressed: () {
                Share.share(
                    'check out my WhatsApp status downloader https://www.webtoddler.com/WhatsappStatusDownloaderApp',
